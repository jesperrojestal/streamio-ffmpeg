...
module FFMPEG
  ...
  class Transcoder
    ...
    def encoding_succeeded?
      @errors << 'no output file created'  && (return false) unless File.exist?(@output_file)
      @errors << 'encoded file is invalid' && (return false) unless encoded.valid?
      true
    end
    ...
    def validate_output_file(&_block)
